...
<body>
    ...
    if (isset($_SESSION["ID"]) && isset($_SESSION["role"]) && $_SESSION["role"] === "FORUM-ADMIN"){
        ...
        while($query->fetch())
        {
            echo "<tr><td>$id</td><td><a href='safetyThread.php?safetyID=".$id."'>$safetyTitle</a></td><td>$safetyContent</td><td>$videoLink</td><td>$createOn</td><td>$lastEdited</td>
            <td>
    ...
    elseif (isset($_SESSION["ID"]) && isset($_SESSION["role"]) && $_SESSION["role"] !== "FORUM-ADMIN"){
        ...
        while($query->fetch())
        {
            echo "<tr><td>$id</td><td><a href='safetyThread.php?safetyID=".$id."'>$safetyTitle</a></td><td>$safetyContent</td><td>$videoLink</td><td>$createOn</td><td>$lastEdited</td></td></tr>";
        }
        echo "</table></div>";
        include "footer.php";
    }
